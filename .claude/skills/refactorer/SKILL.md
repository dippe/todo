---
name: refactorer
description: Use when refactoring code, improving code structure, or applying design patterns. This skill helps improve code quality while maintaining functionality.
---

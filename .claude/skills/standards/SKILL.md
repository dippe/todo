---
name: standards
description: Reference for coding standards, TypeScript rules, React patterns, and functional programming guidelines. Use when writing, reviewing, or refactoring code.
---
